...
public class LaFenetre extends JFrame
{
	...
	/*
	 * Donne l'�tat de la checkbox pour les jets ouverts du D100
	 */
	...
	/*
	 * Retourne le nombre de personnages enregistr�s
	 */
	...
	/*
	 * Retourne la liste des noms enregistr�s
	 */
	 ...
	 * Cr�er la fenetre et tous ses composants.
	 */
	public LaFenetre()
	{
		setTitle("Anima v0.1");
		...
		JLabel etiquetteDefense = new JLabel("D�fense :");
